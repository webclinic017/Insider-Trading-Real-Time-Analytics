...
Script scrapes for Insider Selling data
"""
...
while (datetime.datetime.now().hour)<22:
    ...
    for i in range(2,102):
        ...
        if df is None:
            ...
            if entryExists(df,data):
                ...
                with open('log_sell.csv','a') as fd:
    ...
    if df is None:
        with open("log_sell.csv", "w",newline='') as f:   
            writer = csv.writer(f)
